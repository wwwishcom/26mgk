...
스타트업, 트래픽 변동이 큰 웹서비스, 빠른 시장 진입이 필요한 경우

<img width="683" height="344" alt="image" src="https://github.com/user-attachments/assets/98535ef3-8e69-493d-8aae-c7ff51a705fb" />

- 단일 기관 또는 조직에 의해서만 사용되는 클라우드 인프라
- 해당 기관, 조직의 내부 데이터 센터에 구축하거나, 특정 조직 전용으로 임대
- 기업/조직이 자체적으로 클라우드 인프라를 보유하고 관리하는 것과 비슷
- 보안이 중요한 데이터, 규제 준수가 필요한 업무에 주로 사용
- 퍼블릭 클라우드보다 관리 요소가 더 많이 필요하다!! (직접 구축·운영하는 부담)

대표 기술 : VMware, OpenStack, Hyper-V

장점 : 높은 보안·통제력, 규제 준수 용이

단점 : 초기 구축 비용 큼, 확장성이 퍼블릭보다 떨어짐, 관리 부담 큼

적합한 경우 : 금융권, 공공기관, 대량의 민감 개인정보를 다루는 조직

<img width="689" height="367" alt="image" src="https://github.com/user-attachments/assets/dcd501e9-1468-4b5a-9258-4048c576f9c6" />

프라이빗 클라우드 (보안이 중요한 업무용 데이터 관리) + 퍼블릭 클라우드 (유연성과 확장성을 위한 리소스 활용) 를 결합

두 클라우드는 전용선 또는 VPN으로 연결되어 데이터를 주고받는다.

평소에는 프라이빗에서 운영하다가, 트래픽이 증가하면 퍼블릭 클라우드로 확장해서 추가 컴퓨팅 리소스를 확보하는 방식이다.

<img width="696" height="381" alt="image" src="https://github.com/user-attachments/assets/11f5e447-64fb-4542-8939-872aeecaf82c" />

프론트 ⇒ 대규모 트래픽 수용을 위해 퍼블릭 클라우드에 배치

백엔드 ⇒ 보안·비용 절감을 위해 **프라이빗 클라우드**에 배치

**장점**: 보안과 확장성을 동시에 확보, 비용 최적화

**단점**: 두 환경을 연결·관리하는 복잡도 증가 (네트워크 설정, 데이터 동기화 등)

**적합한 경우**: 보안 데이터는 지키면서도 트래픽 변동에 유연하게 대응하고 싶은 대부분의 중대형 기업 → **최근 가장 선호되는 방식**

<img width="691" height="386" alt="image" src="https://github.com/user-attachments/assets/0e7a8ff1-93be-46fb-ad24-e2441fdc7f44" />

### 클라우드 관리 서비스 제공업체 (MSP)
...
⇒ 클라우드 환경에 관여하지 않고 
본연의 업무에 집중할 수 있도록 서비스 제공

CSP랑 다른 점!

⇒ CSP는 Cloud Service Provider로 클라우드 서비스 제공업체이다.

클라우드 인프라 자체를 소유하고 빌려주는 업체

- 실제 데이터센터, 서버, 스토리지, 네트워크를 **직접 구축·소유**
- IaaS, PaaS, SaaS 같은 클라우드 자원 자체를 판매
- 사용자는 이 인프라 위에서 서비스를 운영

MSP는 **Managed** Service Provider로 클라우드 **관리** 서비스 제공업체이다.

클라우드 인프라를 직접 소유하지 않고, 남의 클라우드(CSP)를 대신 설계·구축·운영해주는 전문 파트너사

기업/조직이 IT 인프라를 효과적으로 관리·유지할 수 있도록 돕는 서비스이며, 핵심 기능은 아래의 3가지이다.

<img width="692" height="358" alt="image" src="https://github.com/user-attachments/assets/e859e80c-d83a-4a3e-a019-ab667e1e1108" />

클라우드는 사용한 만큼 지불하며,

IT 자원 (서버, 스토리지, 스위치) 과 데이터 센터 상면, 전원 공급과 같은 물리적으로 관리할 것이 없어 

많은 기업들이 서비스를 기존 환경에서 **클라우드로** **마이그레이션**을 하고 있다.
